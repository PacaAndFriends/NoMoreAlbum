...
class _AlbumListPageState extends State<AlbumListPage> {
  ...
  final List<double> _scales = [1.0, 1.0, 1.0, 1.0]; // 각 이미지의 크기 상태를 저장하는 리스트
                ...
                Column(
                  children: [
                    Text(
                      ...
                      style:
                          const TextStyle(fontSize: 17, fontFamily: 'Pixeled'),
                    ),
                    Text(
                      imagePath[_currentIndex].split('_')[1].split('.').first,
                      style:
                          const TextStyle(fontSize: 10, fontFamily: 'Pixeled'),
                    ),
                  ],
                ),
